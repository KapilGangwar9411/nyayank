...
export const MissionIcon = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M10.94 12.94L8.11 10.11L6.7 11.52L10.94 15.76L17.29 9.41L15.88 8L10.94 12.94Z" fill="currentColor"/>
  </svg>
);
...
export const IprIcon = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M9.68 13.69L12 11.93L14.31 13.69L13.43 10.84L15.75 9H12.91L12 6.19L11.09 9H8.25L10.56 10.84L9.68 13.69ZM20 10C20 5.58 16.42 2 12 2C7.58 2 4 5.58 4 10C4 14.08 7.05 17.44 11 17.93V21H13V17.93C16.95 17.44 20 14.08 20 10ZM12 16C8.69 16 6 13.31 6 10C6 6.69 8.69 4 12 4C15.31 4 18 6.69 18 10C18 13.31 15.31 16 12 16Z" fill="currentColor"/>
  </svg>
);
...
export const TaxationIcon = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M21 4H3C1.9 4 1 4.9 1 6V18C1 19.1 1.9 20 3 20H21C22.1 20 23 19.1 23 18V6C23 4.9 22.1 4 21 4ZM21 18H3V6H21V18ZM15 8H13V16H15V8ZM11 8H9V16H11V8ZM7 8H5V16H7V8ZM19 8H17V16H19V8Z" fill="currentColor"/>
  </svg>
);
...
export const StartupIcon = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M12 2L4.5 20.29L5.21 21L12 18L18.79 21L19.5 20.29L12 2ZM12 15.5L7.49 17.45L12 6.44L16.51 17.45L12 15.5Z" fill="currentColor"/>
  </svg>
);

export const CorporatesIcon = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M15 11V5L12 2L9 5V7H3V21H21V11H15ZM7 19H5V17H7V19ZM7 15H5V13H7V15ZM7 11H5V9H7V11ZM13 19H11V17H13V19ZM13 15H11V13H13V15ZM13 11H11V9H13V11ZM13 7H11V5H13V7ZM19 19H17V17H19V19ZM19 15H17V13H19V15Z" fill="currentColor"/>
  </svg>
);
...
export const CreatorsIcon = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M15.04 12.19L8.94 8.54V15.85L15.04 12.19ZM10.94 11.46L12.76 12.19L10.94 12.93V11.46Z" fill="currentColor"/>
  </svg>
);

export const LegalIcon = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M13 3H7C5.9 3 5 3.9 5 5V21H7V13H13V21H15V5C15 3.9 14.1 3 13 3ZM13 11H7V5H13V11Z" fill="currentColor"/>
    <path d="M19 3H17V21H19V3Z" fill="currentColor"/>
  </svg>
);
...
export const ExpertiseIcon = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M20 6H12L10 4H4C2.9 4 2.01 4.9 2.01 6L2 18C2 19.1 2.9 20 4 20H20C21.1 20 22 19.1 22 18V8C22 6.9 21.1 6 20 6ZM20 18H4V6H9.17L11.17 8H20V18ZM15 13H9V11H15V13ZM18 16H9V14H18V16Z" fill="currentColor"/>
  </svg>
);
...
export const StrategicIcon = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M9 21H15V19H9V21ZM12 5C8.14 5 5 8.14 5 12C5 15.86 8.14 19 12 19C15.86 19 19 15.86 19 12C19 8.14 15.86 5 12 5ZM12 17C9.24 17 7 14.76 7 12C7 9.24 9.24 7 12 7C14.76 7 17 9.24 17 12C17 14.76 14.76 17 12 17ZM12 9C10.34 9 9 10.34 9 12C9 13.66 10.34 15 12 15C13.66 15 15 13.66 15 12C15 10.34 13.66 9 12 9Z" fill="currentColor"/>
  </svg>
);
...
export const LitigationIcon = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M14 6L10.25 2L6.5 6H3V8H4V20C4 21.1 4.9 22 6 22H18C19.1 22 20 21.1 20 20V8H21V6H14ZM12 4.8L13.8 6H10.2L12 4.8ZM18 20H6V8H18V20Z" fill="currentColor"/>
