      ...
      <div className="about-page-content">
        ...
        <div className="about-page-description">
          <p>
            ...
            We specialize in delivering clear, strategic, and client-focused legal solutions 
        ...
        <section className="about-page-services-section">
          ...
          <div className="about-page-services-grid">
            ...
            <div className="about-page-service-card">
              ...
              <h3>Taxation & Advisory</h3>
              <p>Our taxation team ensures regulatory compliance, tax planning, and representation before authorities.</p>
            </div>
            <div className="about-page-service-card">
              <div className="about-page-service-icon">
                <LitigationIcon />
              ...
              <h3>Litigation</h3>
              <p>Our litigation wing handles civil, criminal, consumer, and matrimonial disputes.</p>
            </div>
          </div>
        </section>
          ...
          <div className="about-page-cta-container">
            ...
            <div className="about-page-cta-content">
              ...
              <div className="about-page-cta-buttons">
                <button className="about-page-cta-button primary" onClick={() => handleScrollTo('contact')}>
                  <ContactIcon />
                  Contact Us
                </button>
                <button className="about-page-cta-button secondary" onClick={() => handleScrollTo('practice-areas')}>
                  <ServicesIcon />
